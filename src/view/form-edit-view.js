...
export default class RedactionView extends AbstractStatefulView {
  _state = null;
  ...
  constructor(point = defaultPoint(), availableOffers = [], availableDestinations = []) {
    super();
    this._state = RedactionView.parsePointToState(point, getAvailableOffers(point.type, availableOffers));
  ...
  reset = (point, availableOffers) => {
    this.updateElement(RedactionView.parsePointToState(point, getAvailableOffers(point.type, availableOffers)));
  };
